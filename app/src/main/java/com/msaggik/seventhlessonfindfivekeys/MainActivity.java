...
//На основе материалов прошлых занятий необходимо добавить
//случайное задание координат нахождения ключей
// easy just fill array random values with Random
        for(int i = 0; i < coordinatesKeys.length; i++) {
            coordinatesKeys[i] = random.nextInt(1000)+1;
        }
